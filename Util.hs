...
-- Copyright https://github.com/Lergin/FritzLightJumper.
...
-- CONTRACT [ All rights belong @ Lergin ]
...
-- DEFINITION [ All rights belong @ Lergin ]
...
-- CONTRACT
genColor :: Pixel -> Canvas

-- PURPOSE
-- Generates an canvas with given colour.

-- DEFINITION
genColor pix = [[pix | _ <- [0..29]] | _ <- [0..11]]
